...
export default function AddBukti({ sppd }) {
    ...
    const handleSubmit = (e) => {
        // inputs.tglberangkat = new Date(inputs.tglberangkat).toISOString()
        // inputs.tglkembali = new Date(inputs.tglkembali).toISOString()
        // inputs.spjId = parseInt(inputs.spjId)
        inputs.sppdId = parseInt (inputs.sppdId)
        console.log(inputs);
        e.preventDefault();
        axios.post('/api/bukti', inputs).then(res => {
            console.log(inputs)
            console.log(res)
        }).catch(err => {
            console.log(err)
