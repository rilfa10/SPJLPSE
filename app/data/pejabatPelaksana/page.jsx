...
import AddData from './addpejabat';
import EditData from './editpejabat';
import DeleteData from './deletepejabat';
...
const DataPage = async () => {
    const datapejabat = await getData()
                ...
                <div className='col-12'>
                    <div className='bg-slate-100 w-85 ml-2 mr-2 p-2 border border-slate-300'>
                        <div className='flex justify-between m-2'>
                            <div className='text-xl items-center'> Pejabat Pelaksana Teknis Kegiatan </div>
                        </div>
                    </div>
                    <div className='rounded-b bg-slate-100 ml-2 mr-2'>
                        ...
                        <table className='w-full'>
                            ...
                            <tbody className='divide-y divide-grey-300'>
                                {datapejabat.map((pejabatPelaksana, index) => (
                                    <tr key={pejabatPelaksana.id}>
                                        ...
                                        <td className='p-3 text-sm text-gray-700 whitespace-nowrape'>
                                            {pejabatPelaksana.pegawai.nama}
                                        </td>
                                        <td className='p-3 text-sm text-gray-700 whitespace-nowrape'>
                                            {pejabatPelaksana.pegawai.nip}
                                        </td>
                                        <td className='p-3 text-sm text-gray-700 whitespace-nowrape'>
                                            {pejabatPelaksana.pegawai.golongan}
                                        </td>
                                        <td className='p-3 text-sm text-gray-700 whitespace-nowrape'>
                                            {pejabatPelaksana.pegawai.jabatan.nama}
                                        </td>
                                        <td className='text-sm text-gray-700 whitespace-nowrape'>
                                            <div className='flex justify-center'>
                                                <EditData pejabatPelaksana={pejabatPelaksana} pegawai={datapegawai}/>
                                                <DeleteData pejabatPelaksana={pejabatPelaksana} />
                                            </div>
                                        </td>
                                    </tr>
                                ))}
